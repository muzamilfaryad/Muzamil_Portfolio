...
export const translations = {
  en: {
    ...
    about: {
      title: 'About',
      me: 'Me',
      description1: "I'm a passionate MERN Stack Developer with over 10 years of experience building modern web applications. I specialize in creating scalable, performant, and user-friendly solutions that drive business growth.",
    ...
    trust: {
      ...
      yearsExpDesc: 'Decade of excellence in MERN stack',
  ...
  ar: {
    ...
    about: {
      title: 'عن',
      me: 'نفسي',
      description1: 'أنا مطور MERN Stack شغوف بأكثر من 10 سنوات من الخبرة في بناء تطبيقات الويب الحديثة. أتخصص في إنشاء حلول قابلة للتطوير وعالية الأداء وسهلة الاستخدام تدفع نمو الأعمال.',
    ...
    trust: {
      ...
      yearsExpDesc: 'عقد من التميز في MERN stack',
  ...
  ur: {
    ...
    about: {
      title: 'میرے',
      me: 'بارے میں',
      description1: 'میں 10 سال سے زیادہ تجربے کے ساتھ ایک پرجوش MERN Stack ڈویلپر ہوں۔ میں جدید ویب ایپلیکیشنز بنانے میں مہارت رکھتا ہوں۔',
    ...
    trust: {
      ...
      yearsExp: 'سال تجربہ',
      yearsExpDesc: 'MERN stack میں فضیلت کی دہائی',
